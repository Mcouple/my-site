...
<form id="data-form-container" ref="form" @submit.prevent="handleSubmit" class="data-form-container">
  <div class="form-item">
    <div class="input-area">
      <input type="text" maxlength="10" v-model="formData.nickname" placeholder="用户名称">
  ...
  <div class="form-item">
    <div class="textarea">
      ...
      <span class="tip tip-two">{{formData.content.length}}/300</span>
    </div>
...
export default {
  ...
  methods:{
    handleSubmit(){
      ...
      this.isSubmiting = true;  //正在提交，防止重复编辑
